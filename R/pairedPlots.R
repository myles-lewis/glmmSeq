...
#' @param modelSize Size of model points 
#' @param modelColour Colour of model fit markers
#' @param modelLineSize Size of model points 
#' @param modelLineColour Colour of model fit lines
