...
[DAS scores](https://www.das-score.nl/en/).
...
at the gene with the most significant interaction 'IGHV3-23':
...
The comparitive fold change (for x1Label variables) between conditions 
...
Genes on the x-y plane, such as IGHJ6, will have associations in the same 
direction whereas 
genes on the x=-y axis have association in _opposite_ directions, such as ADAM12.
...
timepoints which are not present at others. 
